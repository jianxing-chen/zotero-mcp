...
class TestTagsAndCollections:
    ...
    def test_collection_name_resolved_to_key(self, monkeypatch, fake_zot, dummy_ctx):
    ...
    def test_unknown_collection_fails_before_create(self, monkeypatch, fake_zot, dummy_ctx):
