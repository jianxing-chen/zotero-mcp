...
class LocalZoteroReader:
    ...
    def _extract_fulltext_for_item(
        ...
        if chosen:
            ...
            # MinerU '精读' cache first when requested: page-aware,
            # LaTeX/structure-preserving text beats every extractor here.
            if self.prefer_mineru and attachment_key:
                mineru_text = self._read_mineru_cache(attachment_key)
                if mineru_text:
